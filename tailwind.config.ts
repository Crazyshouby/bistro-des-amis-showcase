	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Bistro des Amis custom colors - using CSS variables
				bistro: {
					'brick': 'var(--bistro-brick)',
					'brick-light': 'var(--bistro-brick-light)',
					'sand': 'var(--bistro-sand)',
					'sand-light': 'var(--bistro-sand-light)',
					'wood': 'var(--bistro-wood)',
					'wood-light': 'var(--bistro-wood-light)',
					'olive': 'var(--bistro-olive)',
					'olive-light': 'var(--bistro-olive-light)',
				}
			},
			fontFamily: {
